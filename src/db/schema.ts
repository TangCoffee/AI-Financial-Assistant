...
export const users = pgTable('users',{
        ...
        monthly_income: numeric('monthly_income', { precision: 10, scale: 2 }).notNull().default('0.00'),  // NUMERIC(10,2)
        initial_balance: numeric('initial_balance', { precision: 10, scale: 2 }).notNull().default('0.00'),
        final_balance: numeric('final_balance', { precision: 10, scale: 2 }).notNull().default('0.00'),
...
export const goals = pgTable('goals', {
  ...
  target_amount: numeric('target_amount', { precision: 10, scale: 2 }).notNull().default('0.00'),
